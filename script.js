    ...
    if (navigator.geolocation) {
        navigator.geolocation.getCurrentPosition(function(position) {
            ...
            var userDot = L.divIcon({
                className: 'user-dot', // use a different class for the user's location marker
                html: `<div style="background-color: #4B5320; width: 10px; height: 10px; border-radius: 50%; animation: userBlink 3s infinite;"> </div>`
            });
