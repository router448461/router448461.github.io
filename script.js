window.onload = function() {
    ...
    var polyline = L.polyline([], {color: 'white', weight: 1}).addTo(map); // Change color to white
    ...
    setTimeout(function() {
        ...
        document.getElementById('flash').classList.add('flash-white'); // Ensure this matches the new class name
    }, 30000);
};
